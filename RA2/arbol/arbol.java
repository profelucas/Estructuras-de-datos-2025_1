...
class arbolgeneral{
  ...
  //pese a que no existe una funcion formal de imprimir de manera inorden. No significa que no se pueda.
  ...
  //construya una funcion que permita eliminar un dato dentro del arbol. Tenga en cuenta que puede ser un nodo hijo, hoja o raiz. (puede hacerlo por partes. +100 fichas) 
